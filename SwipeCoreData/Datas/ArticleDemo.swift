...
struct ArticleDemo:Identifiable, Equatable, Hashable {
...
//A
var tshirtA1 = ArticleDemo(name: "White T-Shirt", image: "tshirtA1", description: "Simple white T-Shirt, wore it only 2 times.", category: "Haut", size: "M", state: "Neuf")
var sweaterA1 = ArticleDemo(name: "Sweater Comme des garçons", image: "sweaterA1", description: """
...
var shoesA1 = ArticleDemo(name: "Converses comme des garçons", image: "shoesA1", description: """
...
var pantsA1 = ArticleDemo(name: "Pants Comme des garçons", image: "pantsA1", description: """
...
var scarfA1 = ArticleDemo(name: "Andersson Bell scarf", image: "scarfA1", description: """
...
//B
var tshirtB1 = ArticleDemo(name: "ONLINE CERAMICS t-shirt", image: "tshirtB1", description: """
...
var sweaterB1 = ArticleDemo(name: "AMBUSH sweater", image: "sweaterB1", description: """
...
var shoesB1 = ArticleDemo(name: "Salomon sneakers", image: "shoesB1", description: """
...
var pantsB1 = ArticleDemo(name: "Isset Miyake jeans", image: "pantsB1", description: """
...
var scarfB1 = ArticleDemo(name: "Acne Studios scarf", image: "scarfB1", description: """
...
//C
var tshirtC1 = ArticleDemo(name: "T-Shirt", image: "tshirtC1", description: """
...
""", category: "T-Shirt", size: "S", state: "Good")
var sweaterC1 = ArticleDemo(name: "COLLINA STRADA Hoodie", image: "sweaterC1", description: """
...
var shoesC1 = ArticleDemo(name: "Alexander Wang Sandals", image: "shoesC1", description: """
...
var pantsC1 = ArticleDemo(name: "Kwaidan Editions Jeans", image: "pantsC1", description: """
...
var scarfC1 = ArticleDemo(name: "GUCCI Scarf", image: "scarfC1", description: """
...
//Error
var errorCard = ArticleDemo(name: "Oops...", image: "cardError", description: "", category: "", size: "", state: "")
