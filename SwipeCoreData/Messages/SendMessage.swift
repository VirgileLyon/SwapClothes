...
struct SendMessage : View {
    ...
    @State var messages : [ChatMessage] = [
        ChatMessage(message: "Hello", avatar: "MemojiGirl", color: .gray),
        ChatMessage(message: "Your T-shirt is really interesting, I'd like to exchange it with my scarf :)", avatar: "MemojiGirl", color: .gray)
    ]
